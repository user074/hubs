...
import { tfTest } from './systems/emoModel/tensorflowTest.js'
...
function handleHubChannelJoined (entryManager, hubChannel, messageDispatch, data, permsToken) {
  ...
  ;(async () => {
    ...
    var tfscripts = document.getElementsByClassName('tfjs')
    let tfLength = tfscripts.length

    for (const tfscript of tfscripts) {
